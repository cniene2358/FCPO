...
class ACPO(PPO):
    ...
    def _init(self) -> None:
        ...
        """
        super()._init()
        self._admm: ADMM4 = ADMM4(**self._cfgs.admm_cfgs)
        self.clip_adv = True
        self.clip_adv_c = True
    ...
    def _init_log(self) -> None:
        ...
        self._logger.register_key('Metrics/Rho')
        self._logger.register_key('Metrics/Dual')
        self._logger.register_key('Metrics/Primal')
